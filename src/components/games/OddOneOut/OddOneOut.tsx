          ...
          <div className="intro-card">
            ...
            <div className="intro-instructions">
              ...
              <div className="rules">
                <h3>Правила:</h3>
                <ul>
                  <li>Смотрите на сетку из 4 символов</li>
              ...
              <div className="difficulty-info">
                ...
                <ul>
                  <li>🟢 Раунды 1-3: <strong>Легко</strong></li>
                  <li>🟡 Раунды 4-7: <strong>Средне</strong></li>
                  <li>🔴 Раунды 8-10: <strong>Сложно</strong></li>
                </ul>
              </div>
